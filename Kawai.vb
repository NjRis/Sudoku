Public Class Kawai
    ...
    Private Sub Kawai_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim originalImageKawai As Image = Image.FromFile("C:\Users\iris9\Desktop\B1.2\PD\IHM\BETA\BETA\BETA\IMAGES\Background_HK.jpg")
        Me.BackgroundImage = ResizeImage(originalImageKawai, Me.Size)
    ...
    Private Sub Kawai_Resize(sender As Object, e As EventArgs) Handles Me.Resize ' retirer plus tard
